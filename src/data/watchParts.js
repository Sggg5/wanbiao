...
export const cases = [
  {id:'case-classic-39',type:'case',name:'Classic 39',diameter:39,lugWidth:20,dialDiameter:28.5,price:420,compatibleMovements:['miyota-9015','sellita-sw200'],previewLayer:'/assets/parts/cases/classic-39.webp',assetKey:'cases/classic-39.webp'},
...
export const dials = [
  {id:'dial-midnight-blue',type:'dial',name:'Midnight Blue',sku:'D-001',price:168,diameter:28.5,compatibleMovements:['miyota-9015','sellita-sw200'],previewLayer:'/assets/parts/dials/midnight-blue.webp',assetKey:'dials/midnight-blue.webp',color:'#102b46',fallbackTint:null,glow:'#5f91c1'},
  {id:'dial-obsidian-black',type:'dial',name:'Obsidian Black',sku:'D-002',price:0,diameter:28.5,compatibleMovements:['miyota-9015','seiko-nh35','sellita-sw200'],previewLayer:'/assets/parts/dials/obsidian-black.webp',assetKey:'dials/obsidian-black.webp',color:'#111416',fallbackTint:'#111416',glow:'#707576'},
  {id:'dial-silver-grain',type:'dial',name:'Silver Grain',sku:'D-003',price:120,diameter:28.5,compatibleMovements:['miyota-9015','seiko-nh35','sellita-sw200'],previewLayer:'/assets/parts/dials/silver-grain.webp',assetKey:'dials/silver-grain.webp',color:'#bbb6ad',fallbackTint:'#bbb6ad',glow:'#f4eee2'},
]

export const hands = [
  {id:'hands-dauphine',type:'hands',name:'Dauphine',sku:'H-001',price:120,handSize:{hour:1.5,minute:.9,second:.17},compatibleMovements:['miyota-9015','sellita-sw200'],previewLayer:'/assets/parts/hands/dauphine.webp',assetKey:'hands/dauphine.webp'},
...
export const straps = [
  {id:'strap-steel',type:'strap',name:'Steel Bracelet',sku:'S-001',price:590,lugWidths:[20,22],compatibleMovements:['miyota-9015','seiko-nh35','sellita-sw200'],backLayer:'/assets/parts/straps/steel-back.webp',frontLayer:'/assets/parts/straps/steel-front.webp',assetKey:'straps/steel',material:'steel'},
...
export const casebacks = [
  {id:'caseback-solid',type:'caseback',name:'Solid Steel',sku:'B-001',price:110,compatibleMovements:['miyota-9015','seiko-nh35','sellita-sw200'],compatibleCases:['case-classic-39','case-slim-38','case-sport-40'],previewLayer:null,assetKey:'casebacks/solid.webp'},
  {id:'caseback-exhibition',type:'caseback',name:'Exhibition',sku:'B-002',price:202,compatibleMovements:['miyota-9015','sellita-sw200'],compatibleCases:['case-classic-39','case-slim-38'],previewLayer:null,assetKey:'casebacks/exhibition.webp'},
]
